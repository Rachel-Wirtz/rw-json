...
concept is_default_string = std::constructible_from<T, JString> && std::constructible_from<JString, T>;
...
concept is_default_array = detail::is_single_container<T> && is_user_value<typename T::value_type, typename JArray::value_type>;
